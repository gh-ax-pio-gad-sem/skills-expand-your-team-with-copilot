document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to create share URLs for social media
  function createShareUrls(activityName, description, schedule) {
    ...
    return {
      ...
      email: `mailto:?subject=${encodeURIComponent(activityName + ' at Mergington High School')}&body=${encodeURIComponent(shareText + '\n\nSchedule: ' + schedule + '\n\n' + pageUrl)}`
    };
  }

  // Function to handle social sharing
  function handleShare(platform, activityName, description, schedule) {
    const urls = createShareUrls(activityName, description, schedule);
  ...
  function renderActivityCard(name, details) {
    ...
    const shareButtonsHtml = `
      <div class="share-buttons">
        ...
        <button class="share-btn twitter-share" data-activity="${name}" title="Share on Twitter/X">
    ...
    shareButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        const platform = button.classList.contains('twitter-share') ? 'twitter' :
                        ...
                        button.classList.contains('linkedin-share') ? 'linkedin' : 'email';
